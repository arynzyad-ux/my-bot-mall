...
STOCK_MAP = {
    "v2_5gb":  {"storage": lambda: config.V2RAY_STORAGE_5,  "label": "🚀 انبار ۵ گیگابایت V2ray"},
    "v2_10gb": {"storage": lambda: config.V2RAY_STORAGE_10, "label": "🚀 انبار ۱۰ گیگابایت V2ray"},
    "v2_15gb": {"storage": lambda: config.V2RAY_STORAGE_15, "label": "🚀 انبار ۱۵ گیگابایت V2ray"},
    "v2_20gb": {"storage": lambda: config.V2RAY_STORAGE_20, "label": "🚀 انبار ۲۰ گیگابایت V2ray"},
    "v2_25gb": {"storage": lambda: config.V2RAY_STORAGE_25, "label": "🚀 انبار ۲۵ گیگابایت V2ray"},
    "v2_30gb": {"storage": lambda: config.V2RAY_STORAGE_30, "label": "🚀 انبار ۳۰ گیگابایت V2ray"},
    "v2_40gb": {"storage": lambda: config.V2RAY_STORAGE_40, "label": "🚀 انبار ۴۰ گیگابایت V2ray"},
    "v2_50gb": {"storage": lambda: config.V2RAY_STORAGE_50, "label": "🚀 انبار ۵۰ گیگابایت V2ray"},
    "v2_60gb": {"storage": lambda: config.V2RAY_STORAGE_60, "label": "🚀 انبار ۶۰ گیگابایت V2ray"},
    "v2_70gb": {"storage": lambda: config.V2RAY_STORAGE_70, "label": "🚀 انبار ۷۰ گیگابایت V2ray"},
    "v2_80gb": {"storage": lambda: config.V2RAY_STORAGE_80, "label": "🚀 انبار ۸۰ گیگابایت V2ray"},
    "v2_90gb": {"storage": lambda: config.V2RAY_STORAGE_90, "label": "🚀 انبار ۹۰ گیگابایت V2ray"},
    "v2_100gb": {"storage": lambda: config.V2RAY_STORAGE_100, "label": "🚀 انبار ۱۰۰ گیگابایت V2ray"},
    "express":  {"storage": lambda: config.EXPRESS_CENTRAL_STORAGE, "label": "🔐 مخزن مرکزی اکسپرس"},
}
...
async def check_and_notify_low_stock(context, trigger_event: str = ""):
    ...
    for plan_id, info in all_counts.items():
        label = info['label']
        count = info['count']
        summary_text += f"  ◽ {label}: <code>{count}</code>\n"
