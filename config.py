...
TOKEN = os.getenv("BOT_TOKEN") or "YOUR_BOT_TOKEN_HERE"  # از environment variable بخوان
...
SUPPORT_MESSAGE = 10
ADMIN_MANAGE_STORAGE_MENU, ADMIN_VIEW_STORAGE_ITEMS, ADMIN_ADD_STORAGE_ITEM, ADMIN_REMOVE_STORAGE_ITEM, ADMIN_EDIT_STORAGE_ITEM = range(11, 16)
